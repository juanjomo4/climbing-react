...
export default function HomePage() {
  ...
  useEffect(() => {
    const fetchHighlighted = async () => {
      try {
        // Promise.all lanza ambas peticiones en paralelo
        // Si fueran secuenciales, esperaría shoes, luego news
        // Así ambas viajan a la vez: más rápido
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Encuentra los mejores rocódromos, descubre el equipo perfecto
            y mantente al día con las últimas noticias de escalada.
          </p>
          <div className="flex justify-center gap-4 flex-wrap">
            {/* Link es el equivalente a routerLink en Angular */}
            <Link
              to="/gyms"
