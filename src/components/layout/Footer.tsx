...
export default function Footer() {
  return (
    <footer className="bg-[#1d1f20] border-t border-white/10 mt-auto">

      {/* Footer principal */}
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">

        {/* Columna izquierda: sobre el proyecto */}
        <div>
          <h3 className="text-white font-black text-2xl tracking-widest uppercase mb-4">
            🧗 Climbing Gym
          </h3>
          <p className="text-gray-400 leading-relaxed mb-6">
            Tu guía completa para la escalada indoor en España. Encuentra
            rocódromos, descubre el mejor equipo y mantente al día con
            las últimas noticias del mundo de la escalada.
          </p>
          {/* Iconos sociales */}
      ...
      <div className="border-t border-white/10 py-6 text-center">
        <p className="text-gray-600 text-sm">
          © 2025 Climbing Gym · Desarrollado por{' '}
          <a href="https://linkedin.com/in/juanjomo"
